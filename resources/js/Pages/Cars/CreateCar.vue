            ...
            <div class="col-12 col-sm-8 col-md-6 margin-100">
                <form enctype="multipart/form-data" @submit.prevent="handleSubmit">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input v-model="form.brand" type="text" name="brand" id="brand" class="form-control border-primary">
                        <div v-if="errors.brand" class="d-block mt-2">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input v-model="form.model" type="text" name="model" id="model" class="form-control border-primary">
                        <div v-if="errors.model" class="d-block mt-2">
                            <span class="fs-5 text-danger">
                                {{ errors.model }}
                            </span>
                        </div>
                    ...
                    <div class="form-group mt-3">
                        ...
                        <div v-if="errors.year" class="d-block mt-2">
                            <span class="fs-5 text-danger">
                                {{ errors.year }}
                            </span>
                        </div>
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input v-model="form.horsepower" type="number" name="horsepower" id="horsepower"
                            class="form-control">
                        <div v-if="errors.horsepower" class="d-block mt-2">
                            <span class="fs-5 text-danger">
                                {{ errors.horsepower }}
                            </span>
                        </div>
                    ...
                    <div class="form-group mt-3">
                        ...
                        <div v-if="errors.body_type" class="d-block mt-2">
                            <span class="fs-5 text-danger">
                                {{ errors.body_type }}
                            </span>
                        </div>
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input v-model="form.fuel_type" type="text" name="fuel_type" id="fuel_type"
                            class="form-control border-primary">
                        <div v-if="errors.fuel_type" class="d-block mt-2">
                            <span class="fs-5 text-danger">
                                {{ errors.fuel_type }}
                            </span>
                        </div>
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input v-model="form.emissions" type="number" name="emissions" id="emissions"
                            class="form-control border-primary">
                        <div v-if="errors.emissions" class="d-block mt-2">
                            <span class="fs-5 text-danger">
                                {{ errors.emissions }}
                            </span>
                        </div>
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input v-model="form.gearbox" type="text" name="gearbox" id="gearbox"
                            class="form-control border-primary">
                        <div v-if="errors.gearbox" class="d-block mt-2">
                            <span class="fs-5 text-danger">
                                {{ errors.gearbox }}
                            </span>
                        </div>
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input v-model="form.price_per_day" type="number" name="price_per_day" id="price_per_day"
                            class="form-control border-primary">
                        <div v-if="errors.price_per_day" class="d-block mt-2">
                            <span class="fs-5 text-danger">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input v-model="form.price_per_km" type="number" step="0.01" name="price_per_km" id="price_per_km"
                            class="form-control border-primary">
                        <div v-if="errors.price_per_km" class="d-block mt-2">
                            <span class="fs-5 text-danger">
                                {{ errors.price_per_km }}
                            </span>
                        </div>
                    ...
                    <div id="photoInputsContainer">
                        <div class="form-group mt-3">
                            <label for="carImage1" class="text-dark">Add 1. Car Image:</label><br>
                            <input @input="form.carImage1 = $event.target.files[0]" type="file" name="carImage1"
                                class="carImage form-control border-primary">
                            <div v-if="errors.carImage1" class="d-block mt-2">
                                <span class="fs-5 text-danger">
                                    {{ errors.carImage1 }}
                                </span>
                            </div>
