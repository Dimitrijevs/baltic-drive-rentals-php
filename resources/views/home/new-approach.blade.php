<section class="p-5 bg-primary mt-5">
    <div class="container mt-4">
        <div class="d-flex align-items-center justify-content-between">
            <img class="img-fluid w-50 rounded img-zoom" src="{{ url('/storage/carImages/rAV6sZsT5bpX3MO2pap9vV9KraaTiOpuyxbSCedx.png') }}" alt="">
            <div class="ms-5">
                <h1 class="text-white"><span class="text-warning">A new approach</span> to mobility!</h1>
